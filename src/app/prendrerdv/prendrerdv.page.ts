    ...
    .subscribe(
      ...
      err => {
        ...
        this.alertService.presentToast(
          "Erreur durant la prise de rendez-vous, veuillez réessayer plus tard.",
          "danger"
        );
    }
    );
  ...
  sendAppointment() {
    ...
    .subscribe(
      ...
      err => {
        ...
        this.alertService.presentToast(
          // "Une erreur est survenu lors de la création de l'evenement ...",
